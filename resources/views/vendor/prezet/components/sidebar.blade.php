...
<div
    ...
    class="fixed inset-0 z-40 flex h-full items-start overflow-y-auto bg-gray-900/50 pr-10 backdrop-blur-xs lg:hidden"
>
    <div
...
<div class="sidebar hidden lg:relative lg:block lg:flex-none">
    ...
    >
        <x-prezet::nav :nav="$nav" />
        <div class="sidebar-footer mt-16 text-xs text-gray-400">
            <div class="sidebar-icons mb-2 text-xs text-gray-400">
